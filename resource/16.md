...
Domain            : NT AUTHORITY
Logon Server      : (null)
Logon Time        : 5/10/2025 12:42:08 AM
SID               : S-1-5-19
	msv :	
	tspkg :	
	wdigest :	
...
Authentication Id : 0 ; 23842 (00000000:00005d22)
...
| `download <PATH FILE>`	| Unduh file dari target |
| `upload <PATH FILE>`	| Upload file ke target |
| `search -f *.docx`	| Cari file tertentu |
| `cat <PATH FILE>`	| Lihat isi file|
